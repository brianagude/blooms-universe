...
import type { SanityLink as SanityLinkType, SanityImageRef } from "@/sanity/types";
  ...
  return (
    <header className="py-4 relative z-50">
      <div className="px-4 flex justify-between items-center sm:px-10">
        <Link href="/" className="font-kiante text-2xl leading-tight tracking-wide uppercase">
          {logo ? (
            <Image
        ...
        <button type="button" className={`${linkClassName} lg:hidden`}>Menu</button>
